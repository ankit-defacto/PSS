...
{
	/// <summary>
	/// View Model for Client (Client).
	/// </summary>
	public class ClientViewModel : NotifyPropertyChangedBaseWithOwner
	{
		...
		public ClientViewModel(Guid clientGuid, int clientID, string clientName, string phoneNumber, string email, string address, Guid cityStateZipGuid, Guid paymentInfoGuid, string federatedID, string federatedKey, string federatedIDProvider, string username, string hashedPassword)
		{
