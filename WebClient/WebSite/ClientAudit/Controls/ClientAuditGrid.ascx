<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ClientAuditGrid.ascx.cs" Inherits="ClientAudit_Controls_ClientAuditGrid" %>
...
<ISWebGrid:WebGrid ID="wgClientAudit" runat="server" Height="346px" UseDefaultStyle="True"
	Width="100%" DataMember="ClientAuditCollection" DataSourceID="isdClientAudit" OnInitializeRow="wgClientAudit_InitializeRow">
	<RootTable Caption="Client Audit Collection" DataKeyField="ClientAuditGuid" DataMember="ClientAuditCollection">
		<Columns>
			<ISWebGrid:WebGridColumn Name="ClientAuditGuid" DataMember="ClientAuditGuid" Caption="Client Audit Guid"
			...
			<ISWebGrid:WebGridColumn Name="ClientGuid" DataMember="ClientGuid" Caption="Client"
				Width="200px" EditType="WebComboNET" WebComboID="wcClientAuditClient" DataType="System.Guid">
				<ValueList DataSourceID="isdClientAuditClient" DataMember="ClientCollection"
			...
			<ISWebGrid:WebGridColumn Name="ClientID" DataMember="ClientID" Caption="Client ID"
				Width="100px" TextboxMaxlength="11" InputRequired="true" InputRequiredErrorText="Please fill in 'Client ID'." />
			...
			<ISWebGrid:WebGridColumn Name="CityStateZipGuid" DataMember="CityStateZipGuid" Caption="City State Zip"
				Width="200px" EditType="WebComboNET" WebComboID="wcClientAuditCityStateZip" DataType="System.Guid">
				<ValueList DataSourceID="isdClientAuditCityStateZip" DataMember="CityStateZipCollection"
			...
			<ISWebGrid:WebGridColumn Name="PaymentInfoGuid" DataMember="PaymentInfoGuid" Caption="Payment Info"
				Width="200px" EditType="WebComboNET" WebComboID="wcClientAuditPaymentInfo" DataType="System.Guid">
				<ValueList DataSourceID="isdClientAuditPaymentInfo" DataMember="PaymentInfoCollection"
...
<ISWebCombo:WebCombo ID="wcClientAuditClient" runat="server" DataSourceID="isdClientAuditClient"
	DataValueField="ClientGuid" DataTextField="ClientName"
	Height="20px" Width="200px" UseDefaultStyle="True">
</ISWebCombo:WebCombo>
<ISWebCombo:WebCombo ID="wcClientAuditCityStateZip" runat="server" DataSourceID="isdClientAuditCityStateZip"
	DataValueField="CityStateZipGuid" DataTextField="City"
	Height="20px" Width="200px" UseDefaultStyle="True">
</ISWebCombo:WebCombo>
<ISWebCombo:WebCombo ID="wcClientAuditPaymentInfo" runat="server" DataSourceID="isdClientAuditPaymentInfo"
	DataValueField="PaymentInfoGuid" DataTextField="AmazonToken"
	Height="20px" Width="200px" UseDefaultStyle="True">
</ISWebCombo:WebCombo>
<ISDataSource:ISDataSource ID="isdClientAudit" runat="server" SchemaName="ConcordMfg.PremierSeniorSolutions.Client.ViewModels.ClientAuditCollection"
	SchemaType="CustomObject" LoadOnDemand="True" EnableCaching="No" UseCachedDataOnFirstLoad="No">
	<Tables>
		<ISDataSource:ISDataSourceTable DataObjectTypeName="ConcordMfg.PremierSeniorSolutions.Client.ViewModels.ClientAudit" TableName="ClientAuditCollection"
			TypeName="ConcordMfg.PremierSeniorSolutions.Client.ViewModels.DataAccess" OldValuesParameterFormatString="Original_{0}"
			SelectMethod="GetClientAudits" InsertMethod="InsertClientAudit" UpdateMethod="UpdateClientAudit" DeleteMethod="DeleteClientAudit">
			<InsertParameters>
