...
{
    /// <summary>
    /// Facility Business Entity
    /// </summary>
    public partial class Facility : IComparer<Facility>
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of Facility as a business entity.
        /// </summary>
        public Facility()
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of Facility as a business entity with its properties that are not auto assigned.
        /// </summary>
        ...
        public Facility(Guid facilityGuid, int facilityID, string facilityName, string exerpt, string description, string address, Guid cityStateZipGuid, string phoneNumber, string email, string website, Guid clientGuid, Guid listingTypeGuid, string publicPhotoFileUri,decimal price)
        {
        ...
        #region IComparer<Facility> Members

        /// <summary>
        /// Compares two Facilities. Compares PK and id fields separate from other fields.
        /// </summary>
        /// <param name="a">Facility A</param>
        /// <param name="b">Facility B</param>
